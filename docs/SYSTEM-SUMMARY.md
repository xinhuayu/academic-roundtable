...
- All 7 frontend tests and the production build pass. Frontend coverage includes actual per-turn model-route display, English and translated provenance formatting, ephemeral digest and timeout-retry cards, landing-page multi-source staging, and the voice privacy/review states.
