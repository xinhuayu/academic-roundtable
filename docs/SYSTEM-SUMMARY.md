...
- All 8 frontend tests and the production build pass. Frontend coverage includes actual per-turn model-route display, English and translated provenance formatting, ephemeral digest and timeout-retry cards, parallel closeout author/status copy, landing-page multi-source staging, and the voice privacy/review states.
